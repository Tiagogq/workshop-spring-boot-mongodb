package com.guimaraestiago.workshopmongo.config;
...
import com.guimaraestiago.workshopmongo.domain.Post;
import com.guimaraestiago.workshopmongo.domain.User;
import com.guimaraestiago.workshopmongo.dto.AuthorDTO;
import com.guimaraestiago.workshopmongo.dto.CommentDTO;
import com.guimaraestiago.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveitee!", sdf.parse("22/03/2018"), new AuthorDTO(bob));
